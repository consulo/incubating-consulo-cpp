...
public interface CPsiTokens extends TokenType, CPsiSharpTokens
{
	...
	// keywords
	IElementType NAMESPACE_KEYWORD = new CTokenImpl("NAMESPACE_KEYWORD"); // namespace
	...
	IElementType PRIVATE_KEYWORD = new CTokenImpl("PRIVATE_KEYWORD");
	IElementType STATIC_KEYWORD = new CTokenImpl("STATIC_KEYWORD");
	IElementType EXPLICIT_KEYWORD = new CTokenImpl("EXPLICIT_KEYWORD");  //explicit
	IElementType VIRTUAL_KEYWORD = new CTokenImpl("VIRTUAL_KEYWORD");  //virtual
	...
	IElementType CLASS_KEYWORD = new CTokenImpl("CLASS_KEYWORD"); // class

	// types
	IElementType CHAR_KEYWORD = new CTokenImpl("CHAR_KEYWORD"); // char
	IElementType BOOL_KEYWORD = new CTokenImpl("BOOL_KEYWORD"); // bool
	...
	IElementType BOOL_LITERAL = new CTokenImpl("BOOL_LITERAL");
	...
	IElementType DOUBLE_COLON = new CTokenImpl("DOUBLE_COLON");
	...
	IElementType ARROW = new CTokenImpl("ARROW");
