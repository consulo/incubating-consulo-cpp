...
public interface CTokenType extends TokenType
{
	...
	TokenSet STRING_LITERAL_SET = TokenSet.create(STRING_LITERAL, STRING_INCLUDE_LITERAL, CHARACTER_LITERAL);
	TokenSet COMMENT_SET = TokenSet.create(C_STYLE_COMMENT, END_OF_LINE_COMMENT);
	TokenSet LITERAL_EXPRESSION_SET = TokenSet.create(STRING_LITERAL, STRING_INCLUDE_LITERAL, CHARACTER_LITERAL, INTEGER_LITERAL, LONG_KEYWORD, DOUBLE_LITERAL, FLOAT_LITERAL);
	TokenSet BINARY_EXPRESSION_SET = TokenSet.create(PLUS, MINUS, ASTERISK, DIV, OR, XOR, PERC, TILDE);
